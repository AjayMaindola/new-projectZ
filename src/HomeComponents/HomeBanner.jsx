...
import { Heading1 } from "../style component/StyeldComponent";
...
export default function HomeBanner() {
  return (
    <section className="w-[100%] h-[60vh] bg-[url(../public/images/banner.avif)] bg-no-repeat bg-cover   md:bg-center bg-top text-white ">
      <div className="max-w-[1120px] m-auto py-[15px] px-[15px]">
        <div className=" flex justify-between items-center">
          ...
          <nav className="hidden md:flex">
            <ul className="flex gap-12">
              <li className="md:text-[17px] text-[14px]">Investor Relations</li>
              <li className="md:text-[17px] text-[14px]">Add restaurant</li>
              <li className="md:text-[17px] text-[14px]">Log in</li>
              <li className="md:text-[17px] text-[14px]">Sign up</li>
            </ul>
          </nav>
          <HiOutlineMenu className="sm:hidden" />
        </div>
        <figure className="">
          <img
            className="md:w-[300px] w-[200px] mx-auto md:pt-[75px] pt-[40px]"
            src="../public/images/zamatoimg.avif"
            alt=""
          />
        </figure>
        <h4 className="  text-white text-center py-[25px] md:text-[35px] text-[22px] font-OpenSans font-light">
          Discover the best food & drinks in Delhi NCR
        </h4>
        <div className="max-w-[750px] mx-auto md:h-[50px] h-[100px] bg-white mt-[10px] md:grid md:grid-cols-[35%_auto] grid grid-row-[50%_auto] gap-3    rounded-lg">
          <div className="flex items-center pr-[5px] gap-1 justify-center">
          <TbMapPinFilled className="text-orange-500 md:text-[40px] text-[25px]" />
          <input className="focus:outline-none text-black" type="text" placeholder="Ywca, 1, Ashoka Rd, Hanuman Road Area, Connaught Place, New Delhi, Delhi" />
          <IoMdArrowDropdown className="text-black md:text-[44px] text-[30px] md:border-r-[2px] "/>
          </div>
          <div className="flex items-center md:px-[5px] gap-1 ml-[3px] md:justify-start justify-center ">
          <PiMagnifyingGlassLight className="text-black md:text-[24px] text-[20px] " />
          <input className="py-[5px] focus:outline-none text-black md:w-[58%] w-[81%]" type="text" placeholder="Search for restaurant, cuisine or a dish focuse-none" />
